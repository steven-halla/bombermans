...
# map_surface = pygame.Surface((800, 600)).convert()
...
while running:
    ...
    bg_layer = tmxdata.get_layer_by_name("bg")
    main_layer = tmxdata.get_layer_by_name("main")

    for x, y, image in bg_layer.tiles():
        screen.blit(image, (x * 16, y * 16 + map_y))
